  ...
  seatList: SeatRow[] = [
    {
      hang: "",
      danhSachGhe: [
        { soGhe: "1", gia: 0, daDat: false },
        { soGhe: "2", gia: 0, daDat: false },
        { soGhe: "3", gia: 0, daDat: false },
        { soGhe: "4", gia: 0, daDat: false },
        { soGhe: "5", gia: 0, daDat: false },
        { soGhe: "6", gia: 0, daDat: false },
        { soGhe: "7", gia: 0, daDat: false },
        { soGhe: "8", gia: 0, daDat: false },
        { soGhe: "9", gia: 0, daDat: false },
        { soGhe: "10", gia: 0, daDat: false },
        { soGhe: "11", gia: 0, daDat: false },
        { soGhe: "12", gia: 0, daDat: false },
      ],
    },
    {
      hang: "A",
    ...
    return (
      <div className="text-center">
        <h3 className="text-warning text-uppercase pt-4">
          Đặt vé xem phim tại Sunlight Cinema
        </h3>
